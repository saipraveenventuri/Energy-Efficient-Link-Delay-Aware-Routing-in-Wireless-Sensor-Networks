...
public class WirelessRouter<mouseEvent> implements ActionListener {
	...
	JMenuBar mbr;
	JMenu m, m1, m2;
	JMenuItem mi1, mi2, mi3, mi4, mi21, mi22, mi23, mi24, m5, m6, m7, m8;
	String n1path = "", n2path = "", n3path = "", n4path = "", n5path = "",
			n6path = "", n7path = "", n8path = "", n9path = "", n10path = "",
			n11path = "", n12path = "", n13path = "", n14path = "",
			n15path = "", n16path = "";
	String n17path = "", n18path = "", n19path = "", n20path = "",
			n21path = "", n22path = "", n23path = "", n24path = "",
			n25path = "", n26path = "", n27path = "", n28path = "",
			n29path = "", n30path = "", n31path = "", n32path = "";
	String n1jam = "", n2jam = "", n3jam = "", n4jam = "", n5jam = "",
			n6jam = "", n7jam = "", n8jam = "", n9jam = "", n10jam = "",
			n11jam = "", n12jam = "", n13jam = "", n14jam = "", n15jam = "",
			n16jam = "";
	String n17jam = "", n18jam = "", n19jam = "", n20jam = "", n21jam = "",
			n22jam = "", n23jam = "", n24jam = "", n25jam = "", n26jam = "",
			n27jam = "", n28jam = "", n29jam = "", n30jam = "", n31jam = "",
			n32jam = "";
	...
	ImageIcon jam1 = new ImageIcon(this.getClass().getResource("jam1.png"));
	ImageIcon jam2 = new ImageIcon(this.getClass().getResource("jam2.png"));
	ImageIcon jam3 = new ImageIcon(this.getClass().getResource("jam3.png"));
	ImageIcon jam4 = new ImageIcon(this.getClass().getResource("jam4.png"));
	ImageIcon jam5 = new ImageIcon(this.getClass().getResource("jam5.png"));
	ImageIcon jam6 = new ImageIcon(this.getClass().getResource("jam6.png"));
	ImageIcon jam7 = new ImageIcon(this.getClass().getResource("jam7.png"));
	ImageIcon jam8 = new ImageIcon(this.getClass().getResource("jam8.png"));
	ImageIcon jam9 = new ImageIcon(this.getClass().getResource("jam9.png"));
	ImageIcon jam10 = new ImageIcon(this.getClass().getResource("jam10.png"));
	ImageIcon jam11 = new ImageIcon(this.getClass().getResource("jam11.png"));
	ImageIcon jam12 = new ImageIcon(this.getClass().getResource("jam12.png"));
	ImageIcon jam13 = new ImageIcon(this.getClass().getResource("jam13.png"));
	ImageIcon jam14 = new ImageIcon(this.getClass().getResource("jam14.png"));
	ImageIcon jam15 = new ImageIcon(this.getClass().getResource("jam15.png"));
	ImageIcon jam16 = new ImageIcon(this.getClass().getResource("jam16.png"));
	ImageIcon jam17 = new ImageIcon(this.getClass().getResource("jam17.png"));
	ImageIcon jam18 = new ImageIcon(this.getClass().getResource("jam18.png"));
	ImageIcon jam19 = new ImageIcon(this.getClass().getResource("jam19.png"));
	ImageIcon jam20 = new ImageIcon(this.getClass().getResource("jam20.png"));
	ImageIcon jam21 = new ImageIcon(this.getClass().getResource("jam21.png"));
	ImageIcon jam22 = new ImageIcon(this.getClass().getResource("jam22.png"));
	ImageIcon jam23 = new ImageIcon(this.getClass().getResource("jam23.png"));
	ImageIcon jam24 = new ImageIcon(this.getClass().getResource("jam24.png"));
	ImageIcon jam25 = new ImageIcon(this.getClass().getResource("jam25.png"));
	ImageIcon jam26 = new ImageIcon(this.getClass().getResource("jam26.png"));
	ImageIcon jam27 = new ImageIcon(this.getClass().getResource("jam27.png"));
	ImageIcon jam28 = new ImageIcon(this.getClass().getResource("jam28.png"));
	ImageIcon jam29 = new ImageIcon(this.getClass().getResource("jam29.png"));
	ImageIcon jam30 = new ImageIcon(this.getClass().getResource("jam30.png"));
	ImageIcon jam31 = new ImageIcon(this.getClass().getResource("jam31.png"));
	ImageIcon jam32 = new ImageIcon(this.getClass().getResource("jam32.png"));
	...
	JLabel lgn1, lgn2, lgn3, lgn4, lgn5, lgn6, lgn7, lgn8, lgn9, lgn10, lgn11,
			lgn12, lgn13, lgn14, lgn15, lgn16, lgn17, lgn18, lgn19, lgn20,
			lgn21, lgn22, lgn23, lgn24, lgn25, lgn26, lgn27, lgn28, lgn29,
			lgn30, lgn31, lgn32;

	JLabel lbn1, lbn2, lbn3, lbn4, lbn5, lbn6, lbn7, lbn8, lbn9, lbn10, lbn11,
			lbn12, lbn13, lbn14, lbn15, lbn16, lbn17, lbn18, lbn19, lbn20,
			lbn21, lbn22, lbn23, lbn24, lbn25, lbn26, lbn27, lbn28, lbn29,
			lbn30, lbn31, lbn32, back1;

	JLabel lbs1, lgs1, lbd1, lgd1, ljam;

	WirelessRouter() {

		jf = new JFrame("WIRELESS ROUTER::Energy Efficient Link-Delay Aware Routingz in Wireless Sensor Networks");
		c = jf.getContentPane();
		c.setLayout(null);
		jf.setSize(870, 550);
		...
		m2 = new JMenu("Node History");
		m5 = new JMenuItem("View Routing Path");
		m6 = new JMenuItem("View Boundary Nodes");
		m7 = new JMenuItem("View Traffic Nodes");
		m8 = new JMenuItem("View Total Time Delay");
		...
		back1 = new JLabel();
		back1.setIcon(back);
		back1.setBounds(20, -10, 870, 505);

		lbn2 = new JLabel();
		lbn2.setIcon(bn2);
		lbn2.setBounds(120, 40, 200, 200);
		c.add(lbn2);

		lbn3 = new JLabel();
		lbn3.setIcon(bn3);
		lbn3.setBounds(170, -40, 200, 200);
		c.add(lbn3);

		lbn4 = new JLabel();
		lbn4.setIcon(bn4);
		lbn4.setBounds(180, 50, 200, 200);
		c.add(lbn4);

		lbn5 = new JLabel();
		lbn5.setIcon(bn5);
		lbn5.setBounds(200, 0, 200, 200);
		c.add(lbn5);

		lbn6 = new JLabel();
		lbn6.setIcon(bn6);
		lbn6.setBounds(180, 100, 200, 200);
		c.add(lbn6);

		lbn7 = new JLabel();
		lbn7.setIcon(bn7);
		lbn7.setBounds(270, 00, 200, 200);
		c.add(lbn7);

		lbn8 = new JLabel();
		lbn8.setIcon(bn8);
		lbn8.setBounds(330, 10, 200, 200);
		c.add(lbn8);

		lbn9 = new JLabel();
		lbn9.setIcon(bn9);
		lbn9.setBounds(260, 210, 200, 200);
		c.add(lbn9);

		lbn10 = new JLabel();
		lbn10.setIcon(bn10);
		lbn10.setBounds(250, 280, 200, 200);
		c.add(lbn10);
		...
		lbn14 = new JLabel();
		lbn14.setIcon(bn14);
		lbn14.setBounds(330, 230, 200, 200);
		c.add(lbn14);

		lbn15 = new JLabel();
		lbn15.setIcon(bn15);
		lbn15.setBounds(390, 210, 200, 200);
		c.add(lbn15);

		lbn16 = new JLabel();
		lbn16.setIcon(bn16);
		lbn16.setBounds(350, 280, 200, 200);
		c.add(lbn16);
		...
		lbn18 = new JLabel();
		lbn18.setIcon(bn18);
		lbn18.setBounds(540, 50, 200, 200);
		c.add(lbn18);
		...
		lbn20 = new JLabel();
		lbn20.setIcon(bn20);
		lbn20.setBounds(540, 110, 200, 200);
		c.add(lbn20);

		lbn21 = new JLabel();
		lbn21.setIcon(bn21);
		lbn21.setBounds(620, 70, 200, 200);
		c.add(lbn21);

		lbn22 = new JLabel();
		lbn22.setIcon(bn22);
		lbn22.setBounds(620, 120, 200, 200);
		c.add(lbn22);

		lbn23 = new JLabel();
		lbn23.setIcon(bn23);
		lbn23.setBounds(690, 40, 200, 200);
		c.add(lbn23);
		...
		lbn25 = new JLabel();
		lbn25.setIcon(bn25);
		lbn25.setBounds(500, 200, 200, 200);
		c.add(lbn25);

		lbn26 = new JLabel();
		lbn26.setIcon(bn26);
		lbn26.setBounds(540, 250, 200, 200);
		c.add(lbn26);

		lbn27 = new JLabel();
		lbn27.setIcon(bn27);
		lbn27.setBounds(480, 300, 200, 200);
		c.add(lbn27);

		lbn28 = new JLabel();
		lbn28.setIcon(bn28);
		lbn28.setBounds(640, 200, 200, 200);
		c.add(lbn28);

		lbn29 = new JLabel();
		lbn29.setIcon(bn29);
		lbn29.setBounds(570, 200, 200, 200);
		c.add(lbn29);

		lbn30 = new JLabel();
		lbn30.setIcon(bn30);
		lbn30.setBounds(680, 250, 200, 200);
		c.add(lbn30);

		lbn31 = new JLabel();
		lbn31.setIcon(bn31);
		lbn31.setBounds(600, 280, 200, 200);
		c.add(lbn31);

		lbn32 = new JLabel();
		lbn32.setIcon(bn32);
		lbn32.setBounds(630, 330, 200, 200);
		c.add(lbn32);

		lbd1 = new JLabel();
		lbd1.setIcon(bd1);
		lbd1.setBounds(740, 200, 200, 200);
		c.add(lbd1);
		c.add(back1);
	...
	class PortListener implements Runnable {
		...
		int Abw, bbw, cbw, dbw, ebw, fbw, gbw, hbw, ibw, jbw, kbw, lbw, mbw,
				nbw, obw, Pbw;
		int ae, be, ce, de, ee, fe, ge, he, ie, je, ke, le, me, ne, oe, pe;
		int blw, clw, dlw, elw, flw, glw, hlw, ilw, jlw, klw, llw, mlw, nlw,
				olw, Plw;

		int enr1, enr2, enr3, enr4, enr5, enr6, enr7, enr8, enr9, enr10, enr11,
				enr12, enr13, enr14, enr15, enr16, enr17, enr18, enr19, enr20,
				enr21, enr22, enr23, enr24, enr25, enr26, enr27, enr28, enr29,
				enr30, enr31, enr32;
		int dist1, dist2, dist3, dist4, dist5, dist6, dist7, dist8, dist9,
				dist10, dist11, dist12, dist13, dist14, dist15, dist16, dist17,
				dist18, dist19, dist20, dist21, dist22, dist23, dist24, dist25,
					...
					while (true) {
						...
						if (dist1 < dist2) {
							if (length < enr1) {
								...
								System.out
										.println("The Current Energy=" + len1);
								Statement st4 = con.createStatement();
								String sql4 = "update NW1 set energy= '" + len1
										+ "' where nodename='N1' ";
						...
						if (dist9 < dist10) {
							if (length < enr9) {
								...
								System.out
										.println("The Current Energy=" + len1);
								Statement st4 = con.createStatement();
								String sql4 = "update NW2 set energy= '" + len1
										+ "' where nodename='N9' ";
								st4.executeUpdate(sql4);
						...
						if (dist15 > dist16) {
							if (length < enr16) {
								...
								Thread.sleep(1000);
								lbn16.setVisible(false);
								lbn16.setIcon(gn16);
								lbn16.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist17 < dist18) {
							if (length < enr17) {
								...
								Thread.sleep(1000);
								lbn17.setVisible(false);
								lbn17.setIcon(gn17);
								lbn17.setVisible(true);
								Thread.sleep(1000);
								...
								System.out
										.println("The Current Energy=" + len1);
								Statement st4 = con.createStatement();
								String sql4 = "update NW3 set energy= '" + len1
										+ "' where nodename='N17' ";
								st4.executeUpdate(sql4);
						...
						if (dist17 > dist18) {
							if (length < enr18) {
								...
								Thread.sleep(1000);
								lbn18.setVisible(false);
								lbn18.setIcon(gn18);
								lbn18.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist19 < dist20) {
							if (length < enr19) {
								...
								Thread.sleep(1000);
								lbn19.setVisible(false);
								lbn19.setIcon(gn19);
								lbn19.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist19 > dist20) {
							if (length < enr20) {
								...
								Thread.sleep(1000);
								lbn20.setVisible(false);
								lbn20.setIcon(gn20);
								lbn20.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist21 < dist22) {
							if (length < enr21) {
								...
								Thread.sleep(1000);
								lbn21.setVisible(false);
								lbn21.setIcon(gn21);
								lbn21.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist21 > dist22) {
							if (length < enr22) {
								...
								Thread.sleep(1000);
								lbn22.setVisible(false);
								lbn22.setIcon(gn22);
								lbn22.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist23 < dist24) {
							if (length < enr23) {
								...
								Thread.sleep(1000);
								lbn23.setVisible(false);
								lbn23.setIcon(gn23);
								lbn23.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist23 > dist24) {
							if (length < enr24) {
								...
								Thread.sleep(1000);
								lbn24.setVisible(false);
								lbn24.setIcon(gn24);
								lbn24.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist25 < dist26) {
							if (length < enr25) {
								...
								Thread.sleep(1000);
								lbn25.setVisible(false);
								lbn25.setIcon(gn25);
								lbn25.setVisible(true);
								Thread.sleep(1000);
								...
								System.out
										.println("The Current Energy=" + len1);
								Statement st4 = con.createStatement();
								String sql4 = "update NW4 set energy= '" + len1
										+ "' where nodename='N25' ";
								st4.executeUpdate(sql4);
						...
						if (dist25 > dist26) {
							if (length < enr26) {
								...
								Thread.sleep(1000);
								lbn26.setVisible(false);
								lbn26.setIcon(gn26);
								lbn26.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist27 < dist28) {
							if (length < enr27) {
								...
								Thread.sleep(1000);
								lbn27.setVisible(false);
								lbn27.setIcon(gn27);
								lbn27.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist27 > dist28) {
							if (length < enr28) {
								...
								Thread.sleep(1000);
								lbn28.setVisible(false);
								lbn28.setIcon(gn28);
								lbn28.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist29 < dist30) {
							if (length < enr29) {
								...
								Thread.sleep(1000);
								lbn29.setVisible(false);
								lbn29.setIcon(gn29);
								lbn29.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist29 > dist30) {
							if (length < enr30) {
								...
								Thread.sleep(1000);
								lbn30.setVisible(false);
								lbn30.setIcon(gn30);
								lbn30.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist31 < dist32) {
							if (length < enr31) {
								...
								Thread.sleep(1000);
								lbn31.setVisible(false);
								lbn31.setIcon(gn31);
								lbn31.setVisible(true);
								Thread.sleep(1000);
						...
						if (dist31 > dist32) {
							if (length < enr32) {
								...
								Thread.sleep(1000);
								lbn32.setVisible(false);
								lbn32.setIcon(gn32);
								lbn32.setVisible(true);
								Thread.sleep(1000);
						...
						String timeDelay = Long.toString(ttime);

						long tpt = (Integer.parseInt(timeDelay) / content
								.length()) * 1000;

						long routerhead = (content.length() / 16) * 100;

						Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
						Connection con1 = DriverManager
								.getConnection("jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};Dbq=src\\Database.mdb");

						Statement st11 = con1.createStatement();

						String query = "insert into Results values('" + file
								+ "','" + timeDelay + "','" + tpt + "','"
								+ routerhead + "')";
						st11.executeUpdate(query);

						String tpath = n1path + n2path + n3path + n4path
								+ n5path + n6path + n7path + n8path + n9path
								+ n10path + n11path + n12path + n13path
								+ n14path + n15path + n16path + n17path
								+ n18path + n19path + n20path + n21path
								+ n22path + n23path + n24path + n25path
								+ n26path + n27path + n28path + n29path
								+ n30path + n31path + n32path;

						String jpath = n1jam + n2jam + n3jam + n4jam + n5jam
								+ n6jam + n7jam + n8jam + n9jam + n10jam
								+ n11jam + n12jam + n13jam + n14jam + n15jam
								+ n16jam + n17jam + n18jam + n19jam + n20jam
								+ n21jam + n22jam + n23jam + n24jam + n25jam
								+ n26jam + n27jam + n28jam + n29jam + n30jam
								+ n31jam + n32jam;

						String bpath = bound1 + bound2 + bound3 + bound4;

						JOptionPane.showMessageDialog(null,
								"Selected Neighbour Sensor Nodes =" + tpath);
						JOptionPane.showMessageDialog(null,
								"Selected Traffic Sensor Nodes =" + jpath);
						JOptionPane.showMessageDialog(null,
								"Selected Boundary Sensor Nodes =" + bpath);
						JOptionPane.showMessageDialog(null, "Total Time Delay="
								+ ttime);

						Statement st7 = con.createStatement();
						String sql7 = "insert into boundary values('" + bpath
								+ "')";
						st7.executeUpdate(sql7);

						Statement st8 = con.createStatement();
						String sql8 = "insert into TTime values('" + ttime
								+ "')";
						st8.executeUpdate(sql8);

						Statement st9 = con.createStatement();
						String sql9 = "insert into jamming values('" + jpath
								+ "')";
						st9.executeUpdate(sql9);

						Statement st10 = con.createStatement();
						String sql10 = "insert into routing values('" + tpath
								+ "')";
						...
						if (dest.equalsIgnoreCase("A")) {
							...
							DataOutputStream dout = new DataOutputStream(s3
									.getOutputStream());
							dout.writeUTF(content);
							dout.writeUTF("Routing Path " + tpath);
							DataInputStream dis = new DataInputStream(s3
									.getInputStream());
			...
			if (this.port == 2011) {
				try {
					...
					while (true) {
						...
						String sql1 = "update NW1 set energy='" + energy
								+ "',distance='" + dist + "' where nodename='"
								+ ntype + "'";
						stmt.executeUpdate(sql1);

						DataOutputStream don = new DataOutputStream(s
								.getOutputStream());
			...
			if (this.port == 2012) {
				try {
					...
					while (true) {
						...
						Connection con = db.getConnection();
						Statement stmt = con.createStatement();
						String sql1 = "update NW2 set energy='" + energy
								+ "',distance='" + dist + "' where nodename='"
								+ ntype + "'";
						stmt.executeUpdate(sql1);
			...
			if (this.port == 2013) {
				try {
					...
					while (true) {
						...
						Connection con = db.getConnection();
						Statement stmt = con.createStatement();
						String sql1 = "update NW3 set energy='" + energy
								+ "',distance='" + dist + "' where nodename='"
								+ ntype + "'";
						stmt.executeUpdate(sql1);
			...
			if (this.port == 2014) {
				try {
					...
					while (true) {
						...
						Connection con = db.getConnection();
						Statement stmt = con.createStatement();
						String sql1 = "update NW4 set energy='" + energy
								+ "',distance='" + dist + "' where nodename='"
								+ ntype + "'";
						stmt.executeUpdate(sql1);
