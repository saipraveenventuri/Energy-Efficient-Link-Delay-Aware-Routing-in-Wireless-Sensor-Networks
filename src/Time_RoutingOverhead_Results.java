  ...
  String fname=null,fname1=null,fname2=null,fname3=null,fname4=null,fname5=null,fname6=null,fname7=null;
    	...
    	try
    	{
    		...
    		while(rs.next()==true)
    		{
    	        ...
    	        JFreeChart chart = ChartFactory.createBarChart3D("Energy Efficient Link-Delay Aware Routingz in Wireless Sensor Networks", "Routing Overhead(Kbps) ", "Total Routing Overhead(Kbps)",
