...
public class NodeB extends JFrame implements ActionListener {
	...
	NodeB() {
		...
		ImageIcon img1 = new ImageIcon(this.getClass().getResource("b.png"));
		imagelabel.setIcon(img1);
		imagelabel.setBounds(150, -50, 200, 200);

		jf = new JFrame("Node B::Energy Efficient Link-Delay Aware Routingz in Wireless Sensor Networks");
		c = jf.getContentPane();
		c.setLayout(null);
		jf.setSize(600, 600);
