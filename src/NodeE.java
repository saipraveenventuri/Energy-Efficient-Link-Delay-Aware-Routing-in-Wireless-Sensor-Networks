...
public class NodeE extends JFrame implements ActionListener {
	...
	NodeE() {
		...
		ImageIcon img1 = new ImageIcon(this.getClass().getResource("e.png"));
		imagelabel.setIcon(img1);
		imagelabel.setBounds(150, -50, 200, 200);

		jf = new JFrame("Node E::Energy Efficient Link-Delay Aware Routingz in Wireless Sensor Networks");
		c = jf.getContentPane();
		c.setLayout(null);
		jf.setSize(600,600);
